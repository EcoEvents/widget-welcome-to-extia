...
function UpSide(props) {
  return (
    <div className="logoTopContainer">
      ...
      >
        <img alt="instagram" className="mediaPictoFixed"/>
      </a>
      <a
        className="link"
        target={"_blank"}
        ...
        style={{ borderRadius: "50%", boxShadow: "-3px 10px 25px rgba(0, 0, 0, 0.25)" }}
      >
        <img alt="linkedin" className="mediaPictoFixed"  />
      </a>
    </div>
  );
}
...
function MiddleSide(props) {
  return (
    ...
    >
      ...
      >
        <img alt="mediaCologoTopContainermet" style={{ width: `${props.format !== 's' ? "80%" : "70%"}` }}  />
      </a>
...
function RightSide(props) {
  return (
    <div style={{ width: `${props.format !== 's' ? "25%" : ""}` }} className="right-container">
      ...
      <div className="img">
        <img alt="placeToWork" style={props.format !== 's' ? { width: "45%" } : { width: "30%", marginLeft: "55px" }} />
        <img
